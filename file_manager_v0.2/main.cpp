...
static int ffButtonFunc(GtkWidget *w)
{
        ...
        if (isFile(targetPath) == 1)
        {
                ...
                else if (targetPath.find(".jpg") != std::string::npos || targetPath.find(".png") != std::string::npos || targetPath.find(".gif") != std::string::npos || targetPath.find(".jpeg") != std::string::npos || targetPath.find(".webp") != std::string::npos)
                {
...
void ffpaneInsert(std::string ffList)
{
        ...
        while (std::getline(s, ffname))
        {
                ...
                GtkWidget *ffbuttonlabel = gtk_label_new(ffname.c_str());
...
void createNewFolder(GtkWidget *w)
{
        ...
        std::string button_label = ggh::get_button_label(w);
...
int main(int argc, char *argv[])
{
        ...
        gtk_table_attach(GTK_TABLE(pathRibbon), addressBar, 1, 8, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
        ...
        gtk_widget_set_size_request(addressBar, 1700, 30);
